...
export function VictoryScreen({
  ...
  return (
    <EndShell label="Lo lograste" tone="win">
      <Confetti />
      ...
      <h2 className="font-display mt-2 text-5xl tracking-wide">¡LO LOGRASTE!</h2>
    ...
    <EndShell label="Perdiste" tone="lose">
      ...
      <div className="mt-7 flex w-full flex-col gap-3">
        <button
          type="button"
          onClick={onRestart}
          className="flex items-center justify-center gap-2 rounded-2xl bg-sol py-4 font-extrabold tracking-wide text-night uppercase shadow-[0_10px_30px_-10px_rgb(246_180_14/0.7)] transition active:scale-[0.98]"
        >
